...
func (m Model) View() (v tea.View) {
	...
	if m.err != nil {
		s = "\n" + m.styles.StatusError.Render("  "+m.err.Error()) + "\n\n" +
			m.styles.Help.Render("  r:retry  esc:back  q:quit") + "\n"
		v = tea.NewView(s)
		return v
	}

	s = "\n" + m.table.View() + "\n" +
		m.styles.Help.Render(fmt.Sprintf("  %d pods  ·  enter:logs  esc:back  q:quit", len(m.pods))) + "\n"
...
```go
	...
	s = "\n" + header + m.table.View() + "\n" +
		m.styles.Help.Render(fmt.Sprintf("  %d/%d pods  ·  sort:%s  ·  /:filter  enter:logs  esc:back  q:quit",
...
func (m Model) View() (v tea.View) {
	...
	if m.err != nil {
		s = "\n" + m.styles.StatusError.Render("  "+m.err.Error()) + "\n\n" +
			m.styles.Help.Render("  esc:back  q:quit") + "\n"
		v = tea.NewView(s)
		return v
	}
	...
	s = "\n" + m.styles.TableHeader.Render(header) + "\n" +
		m.viewport.View() + "\n" +
		m.styles.Help.Render("  f:follow  ↑/↓:scroll  esc:back  q:quit") + "\n"
...
- [ ] **Step 4: Handle retry in the pod list**
