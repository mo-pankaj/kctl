...
func (m Model) View() (v tea.View) {
	...
	if m.err != nil {
		s = "\n" + m.styles.StatusError.Render("  "+m.err.Error()) + "\n\n" +
			m.styles.Help.Render("  "+keys.HelpLine(m.keys.Back, m.keys.Quit)) + "\n"
		v = tea.NewView(s)
		return v
	}
	...
	s = "\n" + m.table.View() + "\n" +
		m.styles.Help.Render(fmt.Sprintf("  %d pods  ·  %s", len(m.pods),
			keys.HelpLine(m.keys.Select, m.keys.Back, m.keys.Quit))) + "\n"
...
```go
	...
	s = "\n" + header + m.table.View() + "\n" +
		m.styles.Help.Render(fmt.Sprintf("  %d/%d pods  ·  sort:%s  ·  %s",
			...
			keys.HelpLine(m.keys.Filter, m.keys.SortCycle, m.keys.Select, m.keys.Back, m.keys.Quit))) + "\n"
```
...
func (m Model) View() (v tea.View) {
	...
	s = "\n" + m.styles.TableHeader.Render(header) + "\n" +
		m.viewport.View() + "\n" +
		m.styles.Help.Render("  "+keys.HelpLine(m.keys.Follow, m.keys.Back, m.keys.Quit)+"  ↑/↓:scroll") + "\n"
...
```go
	s = "\n" + m.styles.StatusError.Render("  "+m.err.Error()) + "\n\n" +
		m.styles.Help.Render("  "+keys.HelpLine(m.keys.Retry, m.keys.Back, m.keys.Quit)) + "\n"
```
